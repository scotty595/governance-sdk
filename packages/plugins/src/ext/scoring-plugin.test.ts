...
import { createGovernance, blockTools, CORE_VERSION, satisfiesRange } from "governance-sdk";
import type { AgentRegistration, GovernanceAssessment } from "@governance-sdk/core/types.js";
import { assessAgent, assessFleet } from "../scorer.js";
import { computeBehavioralAdjustments, type BehavioralAssessment } from "../behavioral-scorer.js";
import { scoringPlugin } from "./scoring-plugin.js";
