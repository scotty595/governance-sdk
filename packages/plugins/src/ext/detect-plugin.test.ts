...
import { createInjectionGuard, type InjectionPattern } from "../injection-detect.js";
import { BENCHMARK_DATASET, runBenchmark, type BenchmarkResults, type DetectorFn } from "../injection-benchmark.js";
import { detectPlugin } from "./detect-plugin.js";
