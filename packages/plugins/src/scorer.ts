...
import type {
  ...
  GovernanceLevel,
  AgentStatus,
} from "@governance-sdk/core/types.js";
...
export function assessFleet(
...
): { assessments: GovernanceAssessment[]; summary: import("@governance-sdk/core/types.js").FleetSummary } {
  ...
  return {
    ...
    summary: {
      ...
      byStatus,
      byFramework: byFramework as Record<import("@governance-sdk/core/types.js").AgentFramework, number>,
      byLevel,
