...
/**
 * Extends the shared `AdapterConfig`, so on top of the tool-result options
 * below it accepts every cross-adapter field: `agentId`, `agentName`,
 ...
 * `ctx.targetUrl`).
 */
export interface GovernAgentConfig extends AdapterConfig {
  /**
